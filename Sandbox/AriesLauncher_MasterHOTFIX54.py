...
if IS_PI:
    ...
    TARGET_FPS = 30
    BASE_ICON = 64          # smaller icons to fit comfortably
    SPACING = 82            # tighter spacing fixes right cutoff (was 112)
    FLOW_LAMBDA = 18.0
    SIZE_STEP_PX = 4
    ALPHA_STEP_8 = 32
else:
...
class VAApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        if WIDTH <= 640 or HEIGHT <= 400:
            try:
                ctk.set_widget_scaling(0.82)  # shrinks CTk widgets slightly; canvas coords unchanged
