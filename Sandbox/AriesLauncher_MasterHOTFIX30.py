...
class VAApp(ctk.CTk):
    ...
    _KEYBOARD_DRAG_START_PX = 130.0    # stronger startup deadzone so taps don't become rail drags
    _KEYBOARD_STEP_PX = 300.0          # slower letter stepping; requires a more deliberate drag

    # Home-screen drag tuned for deliberate Apple-TV-like movement.
    _HOME_STEP_PX = 820.0              # much slower app stepping; normal swipe ~= one app
    _HOME_DRAG_START_PX = 140.0        # require a clearly intentional swipe before moving apps
