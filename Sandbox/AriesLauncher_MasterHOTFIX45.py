...
class VAApp(ctk.CTk):
    ...
    def show_browser(self, search_query=None):
        ...
        ctl = ctk.CTkFrame(p, fg_color="transparent")
        ctl.pack(fill="x", padx=10, pady=(0, 6))
        ...
        self._btn(ctl, "Type", self._browser_show_type_keyboard, w=72)
        ...
        ctk.CTkLabel(
            card,
            text="Use Prev/Next to highlight links, Click to open, Type for keyboard, PgUp/PgDn to scroll.",
            font=(FONT, 12),
            text_color=TXTD,
            justify="center",
            wraplength=WIDTH - 80,
