...
class VAApp(ctk.CTk):
    ...
    def _touchpad_move(self, x, y):
        ...
        # Wheel-style horizontal accumulation:
        # keep the instantaneous touch feel, but require deliberate travel
        # before stepping to the next token so the rail does not jump or reverse.
        try:
    ...
    def _touchpad_tap(self):
        if (time.perf_counter() - getattr(self, "_last_touchpad_swipe_at", 0.0)) < 0.18:
            return
