    ...
    def __init__(self, on_swipe=None, on_tap=None, chip_select=None):
        ...
        try:
            ...
            if explicit_cs is not None:
                pin_candidates.append((explicit_cs, _pin("D6"), "explicit/D6"))
            pin_candidates.extend([
                (_pin("CE0"), _pin("D6"), "CE0/D6"),
                (_pin("CE1"), _pin("D6"), "CE1/D6"),
                (_pin("D5"), _pin("D6"), "D5/D6"),
                (_pin("CE0"), _pin("D25"), "CE0/D25"),
                (_pin("CE1"), _pin("D25"), "CE1/D25"),
                (_pin("D5"), _pin("D25"), "D5/D25"),
                (_pin("CE0"), _pin("D24"), "CE0/D24"),
                (_pin("CE1"), _pin("D24"), "CE1/D24"),
                (_pin("D5"), _pin("D24"), "D5/D24"),
            ])
...
class TouchKeyboard:
    ...
    def ensure(self):
        ...
        hdr.grid(row=0, column=0, sticky="ew", padx=12, pady=(2, 2))
        ctk.CTkLabel(
            hdr,
            text="Keyboard",
            font=(FONT, 13, "bold"),
        ...
        keys.grid(row=2, column=0, sticky="nsew", padx=10, pady=(0, 6))
    ...
    def _position(self, force=False):
        ...
        rel_h = 0.42
        abs_h = max(250, min(320, int(app_h * rel_h)))
...
class VAApp(ctk.CTk):
    ...
    def _rotary_click(self):
        """Hardware thread â†’ UI thread: home select, app back/home."""
        self.after(0, lambda: self._global_select() if self.current_view == "home" else self._go_home())
