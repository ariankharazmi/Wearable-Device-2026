...
class VAApp(ctk.CTk):
    ...
    def _touchpad_tap(self):
        ...
        if (now - getattr(self, "_last_touchpad_swipe_at", 0.0)) < 0.18:
            return
        if (now - getattr(self, "_last_touchpad_motion_at", 0.0)) < 0.09:
            return
