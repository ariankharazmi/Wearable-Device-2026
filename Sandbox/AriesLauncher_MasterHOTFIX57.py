...
class VAApp(ctk.CTk):
    ...
    def _global_move(self, direction):
        # Browser element scrolling always has priority — rotate ALWAYS sends
        # Tab/Shift+Tab regardless of whether the keyboard is also visible.
        if self.current_view == "browser" and self._browser_is_open():
    ...
    def _browser_show_type_keyboard(self):
        ...
        self._touch_keyboard.sel_col = 0   # ← is first token in browser mode
